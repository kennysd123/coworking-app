...
Exponer un endpoint REST que retorna los slots ocupados de una sala en un rango
de fechas, permitiendo al cliente cargar el estado inicial de disponibilidad
antes de conectarse al WebSocket (que solo entrega actualizaciones incrementales).
