...
Autenticar usuarios registrados mediante email y contraseña, emitiendo un JWT
access_token de corta duración. Errores de autenticación son genéricos (OWASP A07).
